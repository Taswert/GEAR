...
namespace ErGui {
	...
	bool BetterDragInt(const char* label, int* v, int step = 1, int step_fast = 5, const char* format = "%d", float v_speed = 1.f, int v_min = 0, int v_max = 0, ImGuiSliderFlags flags = 0);
	bool BetterDragInt(ImVec4 color, const char* label, int* v, int step = 1, int step_fast = 5, const char* format = "%d", float v_speed = 1.f, int v_min = 0, int v_max = 0, ImGuiSliderFlags flags = 0);
