...
namespace ErGui {
	...
	inline auto disablSelectObjectInEditorUI1 = geode::Patch::create(reinterpret_cast<void*>(geode::base::get() + 0x12337d), { 0x90, 0x90, 0x90, 0x90, 0x90 });	// Disabling vanilla selections and createUndoObjects in EditorUI::ccTouchEnded
	inline auto disablSelectObjectInEditorUI2 = geode::Patch::create(reinterpret_cast<void*>(geode::base::get() + 0x1235f0), { 0x90, 0x90, 0x90, 0x90, 0x90 });	// So my override will not cause any issues with rob's system
